...
class Elementor_List_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'ImageList', 'elementor-list-widget' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'list_title', [
				'label' => esc_html__( 'Title', 'artbees-extensions' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Your Title Here' , 'artbees-extensions' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'list_image', [
				'label' => esc_html__( 'Image', 'artbees-extensions' ),
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Images Items', 'artbees-extensions' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Your Title Here', 'artbees-extensions' ),
					],
					[
						'list_title' => esc_html__( 'Your Title Here', 'artbees-extensions' ),
					],
        ...
        $this->add_control(
			'icon',
			[
				'label' => esc_html__( 'Icon', 'artbees-extensions' ),
