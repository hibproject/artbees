...
/**
 * Main Artbees Extension
 *
 * The init class that runs the Artbees Extension plugin.
...
final class Artbees_Extension {
	...
	public function i18n() {
		load_plugin_textdomain( 'artbees-extension' );
	}
	/**
	 * Initialize the plugin
	 *
	...
	public function init() {
		...
		require_once 'class-artbees-extension.php';
	}
	/**
	 * Admin notice
	 *
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ARTBEES_EXTENSION ) );
		return sprintf(
			wp_kses(
...
// Instantiate Artbees_Extension.
new Artbees_Extension();